  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20">
          ...
          <GlassCard hover={false} className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="space-y-6 text-gray-300 leading-relaxed">
                ...
                <p>
                  We aim to pioneer home-grown, India-first tRNA therapeutics and AI tooling—solutions built in India for the world.
                </p>
        ...
        >
          <GlassCard hover={false} className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-white mb-6 text-center">tRNA Cloverleaf: Modular Biology</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="space-y-4">
                <p className="text-gray-300 leading-relaxed">
                  Each tRNA molecule is a precisely engineered biological machine with distinct functional domains. 
                  Our AI platform analyzes these modular components to design suppressor variants.
                </p>
                <div className="space-y-2 text-sm">
                  <div className="flex items-center space-x-3">
                    <div className="w-3 h-3 bg-[#32E2E2] rounded-full"></div>
                    <span className="text-gray-300"><strong>Acceptor Stem:</strong> Amino acid attachment site</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-3 h-3 bg-[#E1FF17] rounded-full"></div>
                    <span className="text-gray-300"><strong>D-arm:</strong> Structural stability</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-3 h-3 bg-[#C99EED] rounded-full"></div>
                    <span className="text-gray-300"><strong>Anticodon Loop:</strong> Codon recognition</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-3 h-3 bg-[#38B6FF] rounded-full"></div>
                    <span className="text-gray-300"><strong>TΨC Loop:</strong> Ribosome binding</span>
                  </div>
                </div>
              </div>
              <div className="flex justify-center">
                <div className="relative w-80 h-96">
                  <img
                    src="/assets/about/trna-clover/Clover leaf.png"
                    alt="tRNA Cloverleaf Structure"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <GlassCard className="text-center">
              <div className="w-12 h-12 mx-auto mb-4 flex items-center justify-center">
                <Icon name="restore-function" size={48} className="text-white" />
              </div>
            ...
            <GlassCard className="text-center">
              <div className="w-12 h-12 mx-auto mb-4 flex items-center justify-center">
                <Icon name="global-impact" size={48} className="text-white" />
              </div>
            ...
            <GlassCard className="text-center">
              <div className="w-12 h-12 mx-auto mb-4 flex items-center justify-center">
                <Icon name="ai-driven" size={48} className="text-white" />
              </div>
