...
import SmallWorldFlow from '@/components/SmallWorldFlow';
              ...
              >
                <GlassCard hover={false} className="mb-12">
                  ...
                  <p className="text-gray-300 text-center max-w-3xl mx-auto leading-relaxed">
                    Our proprietary AI platform designs suppressor tRNAs that can read through 
                    premature termination codons while maintaining cellular viability and minimizing 
                    off-target effects.
                  </p>
                </GlassCard>
              ...
              >
                <GlassCard hover={false} className="mb-12">
                  ...
                  <p className="text-gray-300 text-center max-w-3xl mx-auto leading-relaxed mb-8">
                    A comprehensive systems biology platform that models the entire cellular 
                    translation machinery as an interconnected network, revealing novel therapeutic targets.
                  </p>
                </GlassCard>
